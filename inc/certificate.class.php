...
/**
 * Class PluginCertificatesCertificate
 */
         ...
         case "transfer" :
            ...
            if ($item->getType() == 'PluginCertificatesCertificate') {
               foreach ($ids as $key) {
                  ...
                  $state = PluginCertificatesCertificateState::transfer($item->fields["plugin_certificates_certificatestates_id"], $input['entities_id']);
                  if ($state > 0) {
                     $values["id"] = $key;
