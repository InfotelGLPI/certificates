...
/**
 * Class PluginCertificatesCertificate_Item
 */
class PluginCertificatesCertificate_Item extends CommonDBRelation
{
   ...
   /**
    * @param PluginCertificatesCertificate $item
    * @return int
    */
   ...
   /**
    * @param $plugin_certificates_certificates_id
    * @param $items_id
    * @param $itemtype
    * @return bool
    */
   ...
   public static function showForCertificate(PluginCertificatesCertificate $certificate)
   {
      ...
      if ($canedit) {
         ...
         Dropdown::showSelectItemFromItemtypes(array('items_id_name' => 'items_id',
            'itemtypes' => PluginCertificatesCertificate::getTypes(true),
            'entity_restrict'
            => ($certificate->fields['is_recursive']
