...
xgettext *.php */*.php --copyright-holder='Certificates Development Team' --package-name='GLPI - Certificates plugin' --package-version='1.9.0' -o locales/glpi.pot -L PHP --add-comments=TRANS --from-code=UTF-8 --force-po  \
